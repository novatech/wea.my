    ...
    return (
      <div className="container">
        <div className="column is-8 is-offset-2">
              ...
              <div className="card-content">
                <div className="media">
                  <div className="media-content has-text-centered">
                    <p className="title article-title is-capitalized has-text-link">{post.title}</p>
          ...
          <Pagination prevPath={next} prevTitle={nextTitle} nextPath={prev} nextTitle={prevTitle} />
        </div>
      </div>
    );
  }
